...
console.rule("[bold cyan]工具调用示例[/bold cyan]")
console.print(f"  Model: {model}")
console.print(f"  可用工具: [yellow]shell[/yellow], [yellow]read_file[/yellow]")
console.print(f"  输入 [bold yellow]exit[/bold yellow] 退出\n")
...
while True:
    ...
    while tool_round < MAX_TOOL_ROUNDS:
        ...
        print(f"\n[!] 已达到最大工具调用轮次（{MAX_TOOL_ROUNDS}），停止执行")
